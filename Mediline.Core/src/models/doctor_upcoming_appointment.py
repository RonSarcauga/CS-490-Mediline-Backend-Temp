...
class DoctorUpcomingAppointments(db.Model):
    __tablename__ = 'doctor_upcoming_appointments'
    __table_args__ = {'extend_existing': True}  # Prevents modification of the view
    ...
    def __repr__(self):
        return f'<DoctorAppointment {self.appointment_id} - {self.status_label}>'